...
/**
 * This function checks if two floating-point numbers are approximately equal
 ...
 */
static int float_eq(f32 a, f32 b, f32 tol) { return fabsf(a - b) <= tol; }
...
static void loading(const char *section) {
  const char spinner[] = "|/-\\";
